...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        <center>
      <h1 class="display-4">Selamat Datang di Website Kelompok 4 XI Rekayasa Perangkat Lunak 3 SMK Adi Sanggoro</h1>
        <p class="lead">Pemrograman Web dan Perangkat Berjalan</p>
       </center>
      <br>
      <center>
        <img src="img/4.jpg">
